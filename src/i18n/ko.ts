...
const ko: Messages = {
  ...
  'reading.stateLabel': '읽기 상태',
  'reading.state.unread': '안읽음',
  'reading.state.read': '읽음',
  'reading.state.updated': '업데이트됨',
  'reading.state.bookmarked': '북마크',
  'reading.markRead': '읽음으로 표시',
  'reading.markReadAgain': '다시 읽음으로 표시',
  'reading.markUnread': '안읽음으로 되돌리기',
  'reading.updatedNote': '읽은 뒤 내용이 바뀌었습니다',
  'reading.bookmark': '북마크',
  'reading.bookmarked': '북마크됨',
  'reading.removeBookmark': '북마크 해제',
  'reading.bookmarkTitle': '{title} 북마크',
  'reading.progress': '개념 {total}개 중 {read}개 읽음 · 북마크 {bookmarks}개',
  'reading.sectionProgress': '{total}개 중 {read}개 읽음',
  ...
  'concept.partOf': '{parent} 장면의 일부입니다',
