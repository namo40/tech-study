...
Capacity Test は Load Test を逆から読む作業です。p95 が目標を越えるまで負荷を上げ、そのあと目標を下回っていた最後の段階まで戻し、その水準が偶然ではなく安定していると確信できるだけ維持します。上がる途中で見たピークのスループットは答えではありません。誰も合意していない遅延で測った値だからです。
