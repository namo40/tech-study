...
代償はメモリーです。持ち主を失ったエントリが TTL の切れるまでキャッシュを占めます。その TTL は長くしすぎず、バージョンはすべてのインスタンスが安く読める場所に置きます。タグは粗い粒度のいとこにあたり、1 回の削除でひとまとまりを消します。変わったのがキーではなくその集まりであるときに、より合っています。
