...
steps:
  ...
  - title: "팬아웃"
    text: "호출 10개를 보내는 페이지는 가장 느린 하나를 기다립니다. 꼬리가 1%면 페이지 열 개 중 하나가 걸리고, 호출이 100개면 거의 모든 페이지가 걸립니다."
  - title: "Hedge"
    text: "p95만큼 기다린 뒤 다른 복제본에 같은 요청을 한 번 더 보내고 먼저 오는 답을 씁니다. hedge는 트래픽의 몇 퍼센트로 제한합니다. 그렇지 않으면 이미 느린 서비스의 부하를 두 배로 만듭니다."
  - title: "목표는 p99에 둡니다"
    text: "fallback이 있는 timeout은 꼬리에 천장을 만들고, 히스토그램은 그 천장이 목표 아래인지 알려 줍니다. 여기서는 아직 아니며, 그것이 다음에 고칠 일입니다."
related:
  - label: Latency
    slug: latency
  - label: p50
