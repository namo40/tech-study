---
title: "Closed State"
summary: "Closed는 Circuit Breaker의 평상시 상태입니다. 호출은 의존 대상까지 그대로 전달되고, Circuit Breaker는 그중 몇 건이 실패했는지 셉니다."
category: "복원력과 장애 대응"
...
Closed는 Circuit Breaker의 평상시 상태입니다. 모든 호출이 의존 대상까지 그대로 전달되고, Circuit Breaker는 그 호출이 성공했는지 실패했는지 기록합니다.
