---
title: "Deduplication"
summary: "重複排除は、すでに処理した id を覚えておき、同じ id で届いたものを捨てる仕組みです。at-least-once の配信を、意図 1 つに効果 1 つへ変える方法がこれです。"
