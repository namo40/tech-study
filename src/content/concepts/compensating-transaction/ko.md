...
순서가 중요합니다. 보상은 역순으로, 가장 최근 단계부터 실행되고, 각 보상은 자기 단계만 되돌리면 됩니다. 덕분에 보상은 작고 시험하기 쉬운 상태로 남습니다. 환불 핸들러는 결제만 알면 됩니다. 동시에 saga는 실제로 끝난 단계가 무엇인지 기억하고 있어야 합니다. 실행된 적 없는 단계를 보상하는 순간, 받은 적 없는 돈을 돌려주는 시스템이 되기 때문입니다.
