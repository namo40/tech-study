...
export async function loadScene(id: string): Promise<SceneModule | null> {
  switch (id) {
    case 'error-budget':
      return (await import('./error-budget/scene')).default;
    case 'eviction':
      return (await import('./eviction/scene')).default;
    case 'multiplexing':
    ...
    case 'dependency-injection':
      return (await import('./dependency-injection/scene')).default;
    case 'rollback':
      return (await import('./rollback/scene')).default;
    case 'io-completion-port':
      return (await import('./io-completion-port/scene')).default;
    case 'cap-theorem':
      return (await import('./cap-theorem/scene')).default;
    case 'sidecar':
      return (await import('./sidecar/scene')).default;
    ...
    case 'rebalancing':
      return (await import('./rebalancing/scene')).default;
    case 'partitioning':
    ...
    case 'resource-based-authorization':
      return (await import('./resource-based-authorization/scene')).default;
    case 'sql-injection':
